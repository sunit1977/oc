...
class cservices_add extends cservices {
	...
	function LoadDefaultValues() {
		$this->valuename->CurrentValue = NULL;
		$this->valuename->OldValue = $this->valuename->CurrentValue;
	}
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm;
		if (!$this->valuename->FldIsDetailKey) {
			$this->valuename->setFormValue($objForm->GetValue("x_valuename"));
		}
	}
	...
	function RestoreFormValues() {
		global $objForm;
		$this->LoadOldRecord();
		$this->valuename->CurrentValue = $this->valuename->FormValue;
	}
	...
	function RenderRow() {
		...
		$this->valuename->ViewCustomAttributes = "";
			...
			$this->valuename->EditValue = ew_HtmlEncode($this->valuename->CurrentValue);
	...
	function AddRow($rsold = NULL) {
		...
		// valuename
		$this->valuename->SetDbValueDef($rsnew, $this->valuename->CurrentValue, NULL, FALSE);
...
<?php if ($services->valuename->Visible) { // valuename ?>
	<div id="r_valuename" class="form-group">
		<label id="elh_services_valuename" for="x_valuename" class="col-sm-2 control-label ewLabel"><?php echo $services->valuename->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $services->valuename->CellAttributes() ?>>
<span id="el_services_valuename">
<input type="text" data-table="services" data-field="x_valuename" name="x_valuename" id="x_valuename" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($services->valuename->getPlaceHolder()) ?>" value="<?php echo $services->valuename->EditValue ?>"<?php echo $services->valuename->EditAttributes() ?>>
</span>
<?php echo $services->valuename->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div>
<?php if (!$services_add->IsModal) { ?>

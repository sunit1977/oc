...
define("EW_PROJECT_ID", "{57a20c3c-a4d2-4bc3-b7ca-fb4654c3c5cd}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'aC5QU1AbfTkVeAoX', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "och", "qs" => "`", "qe" => "`");
...
define("EW_USER_TABLE", "`reg_users`", TRUE);

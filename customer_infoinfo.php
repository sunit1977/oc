...
//
// Table class for customer_info
//
class ccustomer_info extends cTable {
	var $customerid;
	var $customername;
	var $houseno;
	var $locality;
	...
	function __construct() {
		...
		$this->TableVar = 'customer_info';
		$this->TableName = 'customer_info';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`customer_info`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// customerid
		$this->customerid = new cField('customer_info', 'customer_info', 'x_customerid', 'customerid', '`customerid`', '`customerid`', 3, -1, FALSE, '`customerid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// customername
		$this->customername = new cField('customer_info', 'customer_info', 'x_customername', 'customername', '`customername`', '`customername`', 200, -1, FALSE, '`customername`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->customername->Sortable = TRUE; // Allow sort
		$this->fields['customername'] = &$this->customername;

		// houseno
		$this->houseno = new cField('customer_info', 'customer_info', 'x_houseno', 'houseno', '`houseno`', '`houseno`', 200, -1, FALSE, '`houseno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->houseno->Sortable = TRUE; // Allow sort
		$this->fields['houseno'] = &$this->houseno;

		// locality
		$this->locality = new cField('customer_info', 'customer_info', 'x_locality', 'locality', '`locality`', '`locality`', 200, -1, FALSE, '`locality`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->locality->Sortable = TRUE; // Allow sort
		$this->fields['locality'] = &$this->locality;

		// city
		$this->city = new cField('customer_info', 'customer_info', 'x_city', 'city', '`city`', '`city`', 200, -1, FALSE, '`city`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->city->Sortable = TRUE; // Allow sort
		$this->fields['city'] = &$this->city;

		// state
		$this->state = new cField('customer_info', 'customer_info', 'x_state', 'state', '`state`', '`state`', 200, -1, FALSE, '`state`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->state->OptionCount = 4;
		$this->fields['state'] = &$this->state;

		// remarks
		$this->remarks = new cField('customer_info', 'customer_info', 'x_remarks', 'remarks', '`remarks`', '`remarks`', 201, -1, FALSE, '`remarks`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`customer_info`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("customer_infoview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("customer_infoview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "customer_infoadd.php?" . $this->UrlParm($parm);
		else
			$url = "customer_infoadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("customer_infoedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("customer_infoadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("customer_infodelete.php", $this->UrlParm());
	}

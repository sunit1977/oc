...
<?php
	...
	if ($services_list->AuditTrailOnSearch && $services_list->Command == "search" && !$services_list->RestoreSearch) {
		$searchparm = ew_ServerVar("QUERY_STRING");
		$searchsql = $services_list->getSessionWhere();
		$services_list->WriteAuditTrailOnSearch($searchparm, $searchsql);
	}
...
<?php if ($services->id->Visible) { // id ?>
	...
	<?php } else { ?>
		<th data-name="id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $services->SortUrl($services->id) ?>',2);"><div id="elh_services_id" class="services_id">
	...
	<?php } ?>
<?php } ?>		
<?php if ($services->valuename->Visible) { // valuename ?>
	<?php if ($services->SortUrl($services->valuename) == "") { ?>
		<th data-name="valuename"><div id="elh_services_valuename" class="services_valuename"><div class="ewTableHeaderCaption"><?php echo $services->valuename->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="valuename"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $services->SortUrl($services->valuename) ?>',2);"><div id="elh_services_valuename" class="services_valuename">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $services->valuename->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($services->valuename->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($services->valuename->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
<a id="<?php echo $services_list->PageObjName . "_row_" . $services_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($services->valuename->Visible) { // valuename ?>
		<td data-name="valuename"<?php echo $services->valuename->CellAttributes() ?>>
<span id="el<?php echo $services_list->RowCnt ?>_services_valuename" class="services_valuename">
<span<?php echo $services->valuename->ViewAttributes() ?>>
<?php echo $services->valuename->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php

...
class cservices extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('services', 'services', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// valuename
		$this->valuename = new cField('services', 'services', 'x_valuename', 'valuename', '`valuename`', '`valuename`', 200, -1, FALSE, '`valuename`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
